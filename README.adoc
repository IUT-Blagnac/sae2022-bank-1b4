...
| 03/04   | Gantt V1    |                  | Je n'ai pas un Gantt mais plutôt un planning  copier depuis le sujet. Rappel :  les tâches doivent être affectées et ordonnancer. Attention à l'échelle de temps et au format de livraison. Pour V1 prendre aussi en compte les tâches de développement. EP
|         | CdC V1      |                                   |   
