...
public class ComptesManagement {
    ...
    public CompteCourant creerCompte() {
        ...
        CompteEditorPane editorComptePane = new CompteEditorPane(this.primaryStage, this.dbs);
        currentCompte =  editorComptePane.doCompteEditorDialog(this.clientDesComptes, null, EditionMode.CREATION);
        ...
        if(currentCompte.debitAutorise < 0)
            return null;
