...
public class ClientEditorPaneController implements Initializable {
	...
	/**
	 *Appelé pour initialiser un contrôleur
	 */
	@Override
	...
	/**
	 * Ajoute ou modifie un client si la saisie est valide, permet aussi de supprimer un client
	 */
	@FXML
	...
	/**
	 * Permet de savoir si une saisie est valide
